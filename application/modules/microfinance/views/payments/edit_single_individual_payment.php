...
<section class="panel">
    ...
    <div class="panel-body">
        ...
        <?php echo form_open('microfinance/payments/edit_individual_payment', array("class" => "form-horizontal", "role" => "form"));?>
    	<div class="row">
    		<div class="col-md-8">
    			<div class="form-group">
    				<input type="hidden" name="pid" class="disabled" value="<?php echo $id;?>">
    			</div>
    			<div class="form-group ">
						...
						<select id="cname" class="form-control" name="customer_id" >
							...
							<?php
		                        if($customers->num_rows() > 0)
		                        {
		                            ...
		                            {
		                                 $inst_id = $customer->individual_id;
    			...
    			<div class="form-group ">
					...
					<div class="col-lg-7">
						<input type="datetime-local" id="date_paid" class="form-control" name="date_paid" value="<?php echo date("Y-m-d\TH:i:s", strtotime($date_paid)); ?>">
					</div>
    			</div>
    			<div class="form-group ">
					...
					<div class="col-lg-7">
						<input type="month" id="payment_month" class="form-control" name="payment_month" value="<?php echo date("Y-m", strtotime($payment_month));?>">
					</div>
    			</div>
    		</div>
    	</div>
