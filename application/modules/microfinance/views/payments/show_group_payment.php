            ...
            foreach ($query->result() as $row)
            {
                ...
                '
                    <tr>
                        ...
                        <td>'.$date_paid.'</td>
                        <td>'.$month_paid.'</td>
                        <td><a href="'.site_url().'microfinance/edit-group-payment/'.$group_id.'" class="btn btn-sm btn-success" title="Edit '.$group_name.'"><i class="fa fa-pencil"></i></a></td>
                        <td><a href="'.site_url().'microfinance/delete-group-payment/'.$group_id.'" class="btn btn-sm btn-danger" onclick="return confirm(\'Do you really want to delete '.$group_name.'?\');" title="Delete '.$group_name.'"><i class="fa fa-trash"></i></a></td>
                    </tr> 
                ';
            }
