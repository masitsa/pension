<section class="panel">
		...
		?>
            ...
            <?php echo form_open_multipart('import/import-loans', array("class" => "form-horizontal", "role" => "form"));?>
            
            <div class="alert alert-info">
            	Please ensure that you have set up the following
                <ol>
                    <li>Added members</li>
                    <li>Added loan plans</li>
                </ol>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'import/loans-template';?>">here.</a></li>
