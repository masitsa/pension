	<section class="panel panel-featured panel-featured-info">
        <header class="panel-heading">
            <h2 class="panel-title">Transactions for the last 7 days</h2>
        </header>   
...
var url = config_url+"microfinance/reports/interest_revenue_totals/"+current_timestamp;
...
for(r = 0; r < 8; r++)
{
	$.ajax({
		...
		success:function(data){
			...
			interest.push([current_timestamp, data.interest]);
			loans.push([current_timestamp, data.loans]);
			savings.push([current_timestamp, data.savings]);
			
			current_timestamp = current_timestamp - (86400000);
			url = config_url+"microfinance/reports/interest_revenue_totals/"+current_timestamp;
		},
