    ...
    <section class="panel panel-featured panel-featured-info">
        <header class="panel-heading">
            <h2 class="panel-title">Total loans</h2>
        </header>    
...
$.ajax({
	type:'POST',
	url: config_url+"microfinance/reports/financial_totals",
	cache:false,
	contentType: false,
	processData: false,
	dataType: "json",
	success:function(data){
		...
		var total_services = data.total_loan_types;
		...
		$(function () {
			...
			var d3 = [];
			var ticks = [];alert(total_services);
			...
			function plotWithOptions() {
				$.plot($("#bar-chart"), [ d3 ], {
					...
					xaxis: {axisLabel: "Loans", ticks: ticks},
					yaxis: {axisLabel: "Total Loans", 
