                ...
                <div class="row">
                	<div class="col-md-6">
                            	...
                            	<select class="form-control" name="income_type_id">
                                    ...
                                    if($income_types->num_rows() > 0)
									{
										foreach($income_types->result() as $res)
										{
											...
											if(set_value('income_type_id') == $income_type_id)
											{
												?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                            	<div class="input-group">
                                    ...
                                    <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="income_date" placeholder="Investment date" value="<?php echo set_value("income_date");?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                            	<input type="text" class="form-control" name="income_amount" placeholder="Investment amount" value="<?php echo set_value("income_amount");?>">
                            </div>
                        </div>
					</div>
                	<div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                            	<div class="input-group">
                                    ...
                                    <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="income_payment_date" placeholder="Payment date" value="<?php echo set_value("income_payment_date");?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                            	<input type="text" class="form-control" name="income_payment_amount" placeholder="Payment amount" value="<?php echo set_value("income_payment_amount");?>">
                        </div>
                	</div>
                </div>
				
				<div class="form-group center-align">
					<input type="submit" value="Add income" class="btn btn-success">
				</div>
				<?php
					form_close();
				?>
