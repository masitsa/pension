...
<section class="panel">
    ...
    <div class="panel-body">
    	<?php echo form_open_multipart('microfinance/update-individual-other-document/'.$individual_id, array("class" => "form-horizontal", "role" => "form"));?>
		            ...
		            foreach ($individual_other_documents->result() as $row)
		            {
		                ...
		                '
		                    <tr>
		                        ...
		                        <td>'.$status.'</td>
		                        <td>'.$button.'</td>
		                        <td><a href="'.site_url().'microfinance/delete-individual-identification/'.$document_upload_id.'/'.$individual_id.'" class="btn btn-sm btn-danger" onclick="return confirm(\'Do you really want to delete ?\');" title="Delete"><i class="fa fa-trash"></i></a></td>
		                    </tr> 
		                ';
		            }
